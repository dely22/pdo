...
if(isset($_POST['btn-update']))
{
 ...
 $crudObj->updateRecordById("tbl_users", "first_name = '$fname', last_name = '$lname', email_id = '$email', contact_no = '$contact'", "id", $id);
 if($crudObj)
 {
...
{
 $id = $_GET['edit_id'];
 extract($crudObj->getRecordById("tbl_users", "*", " WHERE id = '$id'")); 
}
